...
alexa = {
    ...
    "astronomy" : ["img", "Astronomy is the study of celestial objects such as stars,planets  and phenomena that originate outside the Earth's atmosphere"],

    "copernicus" : ["img" , "Nicolaus Copernicus proposed a Heliocentric system"],

    "galileo" : ["img" , "Galileo Galilei resurfaced heliocentrism, and discovered four of Jupiter's moons: Io , Europa, Ganymede and Callisto."],

    "heliocentrism" : ["" ," Heliocentrism is the idea that the Sun is at the centre and not the Earth."],

    "andromeda" : ["img", "The Andromeda Galaxy, also known as Messier 31, is a barred spiral galaxy approximately 2.5 million lightyears from Earth and the nearest major galaxy to the MilkyWay."],

    "variable" : ["img" , "Any stars whose brightness fluctuates as seen from Earth are variable stars"],

    "halley's" : ["img" , "Halley's comet can be seen around once every 74 years. First discovered by Edmond Halley."],

    "nebula" : ["img" , "A nebula is cloud of gas and dust in space. It forms new stars."],

    "constellations" : ["img" , "A constellation is an area in the celestial sphere in which a group of stars forms an imaginary outline or pattern. First noted by Babylonians."],

    "super" : ["img" ,  "A point in time in which the moon is closer to the Earth.  The moon appears larger than usual."]}
int = 0
num = 0
...
def quiz(type):
    ...
    if type == 1 :
        ...
        questions = ["What does 19 stand for in Covid-19?",
                    "Which is the smallest country?",
                    "Which galaxy is the closest to the milkyway?",
                    "What is Japan's currency?",
                    "Which strait is between Russia and Alaska?"]
        options = [["19th type of virus" ,"Discovered in 2019" ,"19 Protein Molecules" ],["Vatican City","Monaco","Nauru"] , ["Triangulum Galaxy" , "Andromeda Galaxy" , "Sombrero Galaxy"],
               ["Renminbi" , "won" , "yen"] , ["Bering Strait" , "Strait of Gibraltar" , "Palk Strait"]]
        answers = ["b" , "a" , "b" , "c" , "a" ]
